...
Добавлена сцена `ARMarkerHomeworkScene`.

В сцене:

- веб-камера ищет QR-маркер со ссылкой на репозиторий GitHub
- QR-маркер находится в `Assets/Textures/ARHomeworkQrMarker.png`
- после нахождения маркера игра из прошлых домашних работ появляется на месте маркера
